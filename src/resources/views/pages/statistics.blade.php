...
<head>
    ...
    <title>Statistika - CashFlow AI</title>
    <meta name="description" content="Biznesingizning kirim va chiqim statistikasi">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <h1 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-2">
                    Moliyaviy <span
                        class="bg-gradient-to-r from-blue-600 to-cyan-600 dark:from-blue-400 dark:to-cyan-400 bg-clip-text text-transparent">Statistika</span>
                </h1>
                <p class="text-slate-600 dark:text-slate-400">Biznesingizning kirim va chiqim tahlili</p>
            </div>

            <!-- Time Period Filter -->
            <div class="mb-8 flex flex-wrap gap-4">
                <button onclick="updatePeriod('month')" id="btn-month"
                    class="px-6 py-2 bg-blue-500 text-white rounded-lg font-medium transition-all hover:bg-blue-600">
                    Oylik
                </button>
                <button onclick="updatePeriod('quarter')" id="btn-quarter"
                ...
                <button onclick="updatePeriod('year')" id="btn-year"
                    class="px-6 py-2 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg font-medium transition-all hover:bg-slate-300 dark:hover:bg-slate-700">
                    Yillik
                </button>
            </div>
            ...
            <div class="grid md:grid-cols-4 gap-6 mb-8">
                <div class="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-6 text-white">
                    ...
                    <div class="text-3xl font-bold mb-1" id="total-revenue">125.5M</div>
                    <div class="text-blue-100 text-sm">Jami kirim</div>
                </div>

                <div class="bg-gradient-to-br from-red-500 to-pink-500 rounded-2xl p-6 text-white">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-3xl font-bold mb-1" id="total-expenses">89.2M</div>
                    <div class="text-red-100 text-sm">Jami xarajat</div>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl p-6 text-white">
                    ...
                    <div class="text-3xl font-bold mb-1" id="net-profit">36.3M</div>
                    <div class="text-green-100 text-sm">Sof foyda</div>
                </div>
                ...
                <div class="bg-gradient-to-br from-purple-500 to-indigo-500 rounded-2xl p-6 text-white">
                    ...
                    <div class="text-3xl font-bold mb-1" id="profit-margin">28.9%</div>
                    <div class="text-purple-100 text-sm">Foyda marjasi</div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-6">Kirim va Chiqim Taqqoslash</h3>
                    <canvas id="revenueExpensesChart"></canvas>
                </div>

                <!-- Profit Trend Chart -->
                <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-6">Foyda Tendensiyasi</h3>
            ...
            <!-- Detailed Breakdown -->
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-6">Xarajatlar Taqsimoti</h3>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-slate-700 dark:text-slate-300">Ish haqi</span>
                            </div>
                            <span class="font-bold text-slate-900 dark:text-white">35.2M (39.5%)</span>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                            <div class="flex items-center gap-3">
                                <div class="w-4 h-4 bg-red-500 rounded"></div>
                                <span class="text-slate-700 dark:text-slate-300">Operatsion xarajatlar</span>
                            </div>
                            <span class="font-bold text-slate-900 dark:text-white">26.8M (30.0%)</span>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                            <div class="flex items-center gap-3">
                                <div class="w-4 h-4 bg-yellow-500 rounded"></div>
                                <span class="text-slate-700 dark:text-slate-300">Marketing</span>
                            </div>
                            <span class="font-bold text-slate-900 dark:text-white">15.6M (17.5%)</span>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                            <div class="flex items-center gap-3">
                                <div class="w-4 h-4 bg-green-500 rounded"></div>
                                <span class="text-slate-700 dark:text-slate-300">Boshqa</span>
                            </div>
                            <span class="font-bold text-slate-900 dark:text-white">11.6M (13.0%)</span>
                        </div>
                    </div>
                </div>
            </div>
